...
[Keyless]
[Table("temp_M1C001")]
public partial class temp_M1C001
{
    [StringLength(255)]
    ...
    [StringLength(255)]
    public string? UnitStatus_CS1 { get; set; }

    [StringLength(255)]
    public string? RemarkUnitStatus_CS1 { get; set; }

    [StringLength(255)]
    public string? LetterDueDate_CS1 { get; set; }

    [StringLength(255)]
    public string? ExpectTransfer1 { get; set; }

    [StringLength(255)]
    public string? TransferDueDate_CS1 { get; set; }
    ...
    [StringLength(255)]
    public string? UnitStatus_CS2 { get; set; }
