...
public partial class BmMasterQuestion
{
    ...
    public virtual ICollection<BmMasterQuestionAnswer> BmMasterQuestionAnswers { get; set; } = new List<BmMasterQuestionAnswer>();
