        ...
        public override List<RollingPlanSummaryModel> sp_GetProjecTargetRollingPlanList_GetListTargetRollingPlan(RollingPlanSummaryModel en)
        {
            using (SqlConnection SqlCon = new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    SqlCmd.Parameters.Add(new SqlParameter("@Act", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_Act);

                    SqlCmd.Parameters.Add(new SqlParameter("@Year", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_Year);

                    SqlCmd.Parameters.Add(new SqlParameter("@Quarter", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_Quarter);

                    SqlCmd.Parameters.Add(new SqlParameter("@Month", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_Month);

                    SqlCmd.Parameters.Add(new SqlParameter("@ProjectID", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_ProjectID);

                    SqlCmd.Parameters.Add(new SqlParameter("@Bu", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_Bu);

                    SqlCmd.Parameters.Add(new SqlParameter("@PlanTypeID", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_PlanTypeID);

                    SqlCmd.Parameters.Add(new SqlParameter("@ProjectStatus", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_ProjectStatus);

                    SqlCmd.Parameters.Add(new SqlParameter("@ProjectPartner", SqlDbType.NVarChar)).Value
                        = Commond.FormatExtension.NullToString(en.L_ProjectPartner);
